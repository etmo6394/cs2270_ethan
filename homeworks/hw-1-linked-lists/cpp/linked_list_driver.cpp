...
int main () {
  ...
  // Test insert_data and insert
  insert_data(&head, 1, 21);
  cout << "Should be 5, 21, 42, 32, 99, 7, 10: " << report(head) << endl;
  node* twelve = init_node(12);
  insert(&head, 4, twelve);
  cout << "Should be 5, 21, 42, 32, 12, 99, 7, 10: " << report(head) << endl;
  // test remove
  remove(&head, 2);
  cout << "Should be 5, 21, 32, 12, 99, 7, 10: " << report(head) << endl;
  // test size and contains
  cout << "Should be 7: " << size(head) << endl;
  node* empty_list2 = NULL;
  cout << "Should be 0: " << size(empty_list2) << endl;
  cout << "Should be 1: " << contains(head, 5) << endl;
  cout << "Should be 0: " << contains(head, 27) << endl;
